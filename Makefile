...
main.exe : $(sourcefile_path)main.c Shader.o Sprite.o Tile.o
	gcc $(flags) -o main.exe $(headerlocations) $(librarylocations) $(sourcefile_path)main.c Shader.o Sprite.o Tile.o $(sourcefile_path)glad.c $(libs) 
...
Tile.o : $(sourcefile_path)Tile.c
	gcc $(flags) $(headerlocations) $(librarylocations) -c $(sourcefile_path)Tile.c -o Tile.o $(libs)
